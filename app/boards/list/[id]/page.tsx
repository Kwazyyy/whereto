                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <div className="relative bg-[#161B22] rounded-xl p-5 w-full max-w-sm shadow-2xl border border-white/10">
                            ...
                            <div className="flex gap-3 mt-3">
                                <a
                                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent("Check out this list on WhereTo")}`}
                                    target="_blank"
                                ...
                                <a
                                    href={`https://wa.me/?text=${encodeURIComponent("Check out this list on WhereTo: " + shareUrl)}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-gray-300"
                                >
