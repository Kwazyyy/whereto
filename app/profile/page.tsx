...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-dvh bg-white dark:bg-[#0E1116] pb-32 lg:pb-6 relative">
      ...
      <header className="px-5 pt-2 pb-1 h-16 lg:hidden flex justify-end items-center">
