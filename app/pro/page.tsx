  ...
  return (
    <div className="min-h-screen bg-[#0E1116] flex flex-col items-center justify-center px-6 text-center">
      <div className="max-w-sm">
        <div className="w-16 h-16 rounded-2xl bg-[#CA8A04]/10 border border-[#CA8A04]/20 flex items-center justify-center mx-auto mb-6">
        ...
        <p className="text-[#CA8A04] font-semibold text-sm uppercase tracking-wider mb-4">Coming Soon</p>
