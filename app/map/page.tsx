        ...
        <AnimatePresence>
          {loading && userLocation && (
            ...
            >
              ...
              <span className="text-xs font-semibold text-[#2D2D2D] dark:text-[#e8edf4]">Searching...</span>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        {userLocation && (
          <div className="absolute top-3 left-3 z-10 flex flex-col gap-2 bg-white/95 dark:bg-[#1a1a2e]/95 backdrop-blur-sm rounded-xl px-3 py-2.5 shadow-md border border-gray-100 dark:border-white/10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-semibold text-[#2D2D2D] dark:text-[#e8edf4]">Saved</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3.5 h-3.5 rounded-full bg-[#3B82F6] shadow-sm shrink-0" />
              <span className="text-[11px] font-semibold text-[#2D2D2D] dark:text-[#e8edf4]">Nearby</span>
            </div>
          </div>
        )}
      </div>
