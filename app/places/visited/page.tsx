export default function VisitedPage() {
    return (
        <div className="min-h-dvh bg-white dark:bg-[#0f0f1a] flex flex-col items-center justify-center p-5 text-center">
            ...
            <h1 className="text-2xl font-bold text-[#2D2D2D] dark:text-[#e8edf4] mb-2">Places You&apos;ve Been</h1>
            ...
            <a
                href="/profile"
                className="px-6 py-3 rounded-full bg-gray-100 dark:bg-[#1a1a2e] text-[#2D2D2D] dark:text-[#e8edf4] font-medium hover:bg-gray-200 dark:hover:bg-[#22223b] transition-colors"
            >
                Back to Profile
            </a>
        </div>
