    ...
    return (
        ...
        >
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute top-4 right-4 text-[#8B949E] hover:text-white transition-colors duration-200 cursor-pointer"
                >
                ...
                <h2 className="text-lg font-bold mb-1 text-[#e8edf4]">
                    Add a Friend
                </h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                    <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-[#0E1116] border border-[#30363D] text-white placeholder-[#8B949E] transition-colors duration-200 focus:border-[#E85D2A] focus:ring-1 focus:ring-[#E85D2A]/30 focus:outline-none"
                    />
                ...
                <p className="text-sm font-semibold text-[#C9D1D9] mb-3">Invite Friends</p>
                <div className="flex gap-3">
                    <button
                        onClick={handleCopyLink}
                        className="flex-1 flex flex-col items-center gap-2 py-3 rounded-xl border border-[#30363D] hover:border-[#E85D2A] cursor-pointer transition-colors duration-200"
                    >
