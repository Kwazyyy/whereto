...
export default function BottomNav() {
  ...
  if (pathname === "/landing" || pathname.startsWith("/business") || pathname === "/for-business" || pathname.startsWith("/lists") || pathname === "/pro" || pathname === "/privacy" || pathname === "/terms" || pathname === "/auth" || pathname === "/onboarding" || (pathname.startsWith("/places/") && pathname.endsWith("/photos"))) {
    return null;
  }
