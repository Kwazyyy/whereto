                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {screen === "pick_friend" && (
                            ...
                            >
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <h2 className="text-base font-bold text-[#0E1116] dark:text-[#e8edf4]">
                                        Send to a Friend
                                    </h2>
                                </div>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2.5 mb-4 p-3 rounded-2xl bg-gray-50 dark:bg-[#1C2128]">
                                    ...
                                    <p className="text-sm font-semibold text-[#0E1116] dark:text-[#e8edf4]">
                                        Sending <span className="text-[#E85D2A]">{place.name}</span> to{" "}
                                        {selectedFriend.name?.split(" ")[0] ?? selectedFriend.email?.split("@")[0]}
                                    </p>
                                </div>
                        ...
                        {screen === "sent" && (
                            ...
                            >
                                ...
                                <p className="text-lg font-bold text-[#0E1116] dark:text-[#e8edf4] mb-1">
                                    Sent!
                                </p>
                                <p className="text-sm text-gray-400 dark:text-gray-500">
                                    {selectedFriend?.name?.split(" ")[0] ?? "Your friend"} will see{" "}
                                    <span className="font-semibold text-[#0E1116] dark:text-[#e8edf4]">
                                        {place.name}
                                    </span>{" "}
