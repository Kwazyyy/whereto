...
const EXCLUDED_PATHS = ["/landing", "/business", "/for-business", "/lists", "/pro", "/privacy", "/terms", "/auth", "/onboarding"];
    ...
    >
      ...
      <div className="px-4 xl:px-5 pt-6 pb-4 shrink-0 flex items-center justify-center xl:justify-start">
        <Link href="/" className="flex items-center">
          <span className="text-3xl tracking-tight text-[#E85D2A]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800 }}>S</span>
          <span className="text-3xl tracking-tight text-[#E85D2A] hidden xl:inline" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800 }}>avrd</span>
        </Link>
      </div>
