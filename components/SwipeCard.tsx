                        ...
                        <div className="px-5 pt-2 relative z-10">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-gray-200 dark:border-white/15 text-[#2D2D2D] dark:text-[#e8edf4] font-semibold text-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
