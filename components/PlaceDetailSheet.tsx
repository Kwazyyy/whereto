        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="px-5 -mt-6 relative">
            ...
            <div className="flex gap-3 mt-8 pb-10">
              ...
              <button className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-gray-200 dark:border-white/15 text-[#0E1116] dark:text-[#e8edf4] font-semibold text-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
